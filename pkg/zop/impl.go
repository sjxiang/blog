...
var _ Logger = &zapLoggerImpl{}


var (
	mu sync.Mutex

	// std 定义了使用默认配置的全局 Logger 
...
func NewLogger(opts *Options) *zapLoggerImpl {
	...
	cfg := &zap.Config{
		// 是否在日志中显示调用日志所在的文件和行号，例如：`"caller":"blog/blog.go:75"`
